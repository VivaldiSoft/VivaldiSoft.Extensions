...
namespace VivaldiSoft.Extensions.Tests
{
    public class DataTableExtensionsTest
    {
        ...
        public void ToHtmlTableCss(DataTable table, string expected, DataTableExtensions.TableCssClasses tableCssClasses)
        {
        ...
        {
            readonly DataTableExtensions.TableCssClasses tableCssClasses = new DataTableExtensions.TableCssClasses()
            {
                Table = "c-table",
                Tr = "c-tr-1 c-tr-2",
                Th = "c-th",
